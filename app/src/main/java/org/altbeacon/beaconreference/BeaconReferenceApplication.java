...
public class BeaconReferenceApplication extends Application implements BootstrapNotifier {
    ...
    public void onCreate() {
       ...
       // createNotificationChannel();
        ...
        builder.setContentTitle("Monitoring your Distance");
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel("My Notification Channel ID",
                    "My Notification Name", NotificationManager.IMPORTANCE_HIGH);
    ...
    private void sendNotification() {
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(this)
                        .setContentTitle("Hogist Social-distancing Application")
                        .setContentText("A person is nearby.")
                        .setSmallIcon(R.drawable.hogist_logo);
